...
#include "Game.hpp"
#include "Map.h"
#include "../2D/Entity/Components.h"
#include "Vector2D.h"
#include <iostream>
#include "../2D/Entity/InputHandler.h"
#include "Collision.h"
#include "../2D/Entity/Collider.h"
#include "../2D/Entity/UI/UILabel.h"
#include "../2D/Entity/UI/UIButton.h"
...
void Game::init(const char *title, int xpos, int ypos, int width, int height, bool fullscreen) {
    ...
    assets->addTexture("terrain", "C:/Users/UZER/Documents/GameDev/Lotos/Lotos/src/engine/assert/terrain_ss.png");
    assets->addTexture("player", "C:/Users/UZER/Documents/GameDev/Lotos/Lotos/src/engine/assert/player_anims.png");
    assets->addTexture("projectile", "C:/Users/UZER/Documents/GameDev/Lotos/Lotos/src/engine/assert/proj.png");

    assets->addFont("arial", "C:/Users/UZER/Documents/GameDev/Lotos/Lotos/src/engine/assert/arial.ttf", 16);

    map = new Map("terrain", 3, 32);

    map->LoadMap("C:/Users/UZER/Documents/GameDev/Lotos/Lotos/src/engine/assert/mapNew.map", 25, 20);
